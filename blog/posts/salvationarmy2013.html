...
<head>
<title>Team 4334 - Salvation Army Toy Distribution</title>
<meta charset="utf-8">
...
<h1 style="margin-top:10px; float:left">Salvation Army Toy Distribution</h1>
<a href="../blog3.html"><p style="float:right; padding-top:20px"><< Back to Blog</p></a>
<p style="clear:both">November 23, 2013</p>
...
<div class="container">
<img class="img-responsive" style="margin-top:15px; width:150%; margin-bottom:15px" src="../../resources/img/salvationarmy2013.JPG" />
</div>
