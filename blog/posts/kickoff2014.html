...
<head>
<title>Team 4334 - Kickoff 2014</title>
<meta charset="utf-8">
...
<h1 style="margin-top:10px; float:left">Kickoff 2014</h1>
<a href="../blog3.html"><p style="float:right; padding-top:20px"><< Back to Blog</p></a>
<p style="clear:both">January 5, 2014</p>
<p>At kickoff today FIRST unveiled the 2014 FRC game. These are the game rules:</p>
...
<div class="container">
<img class="img-responsive" style="margin-top:15px; margin-bottom:15px" src="../../resources/img/aalogob.png" />
</div>
